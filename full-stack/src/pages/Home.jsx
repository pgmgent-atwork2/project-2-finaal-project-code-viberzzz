              ...
              <li key={unit.id}>
                ...
                {unit.waarden_range && (
                  <div style={{ marginLeft: '20px', marginTop: '10px', fontSize: '14px' }}>
                    <p><strong>Waarden Range:</strong></p>
                    <ul>
                      <li>pH: {unit.waarden_range.ph_min} - {unit.waarden_range.ph_max}</li>
                      <li>Temperatuur: {unit.waarden_range.temperatuur_min}°C - {unit.waarden_range.temperatuur_max}°C</li>
                      ...
                      <li>Microbiologie Max: {unit.waarden_range.microbiologie_max}</li>
                    </ul>
                  </div>
                 ...
                 {unit.latestWaarde && (
                <div style={{ marginLeft: '20px', marginTop: '10px', fontSize: '14px' }}>
                    <p><strong>Laatste Waarde:</strong></p>
                    <ul>
                      ...
                      <li>Microbiologie Max: {unit.latestWaarde.microbiologie}</li>
                    </ul>
                  </div>
                )}
              </li>
